                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
                                        ...
                                        {!! Form::input('datetime-local', 'datetime', $daily_performance->datetime ? date('Y-m-d H:i', strtotime($daily_performance->datetime)) : date('Y-m-d H:i'), ['class' => 'form-control', 'placeholder' => 'Enter Date and Time', 'id' => 'datetime']) !!}
